...
#define OPI (3.14159265358979323846f)
...
{
	return rad * 180.0f / OPI;
}

inline float deg2rad(float deg) 
{
	return deg * OPI / 180.0f;
}

inline int oboy_roundf(float d) 
{ 
...
inline int roundToNearestMultipleOf(float d, float n)
{
	...
	float normalizedRounded = (float)oboy_roundf(normalized);

...
Storage::StorageResult LinuxStorage::FileOpen( const char *pFilePathUtf8, int modeFlags, BoyFileHandle *pFileHandleOut )
{
...
Storage::StorageResult LinuxStorage::FileRead( BoyFileHandle fileHandle, void *pBuffer, int readSizeBytes )
{
	StorageResult result = STORAGE_FAIL;
...
Storage::StorageResult LinuxStorage::FileWrite( BoyFileHandle fileHandle, const void *pBuffer, int writeSizeBytes )
{
	StorageResult result = STORAGE_FAIL;
...
Storage::StorageResult LinuxStorage::FileClose( BoyFileHandle fileHandle )
{
	StorageResult result = STORAGE_FAIL;
...
int LinuxStorage::FileGetSize( BoyFileHandle openFileHandle )
{
	int sizeBytes = -1;
...
FILE *LinuxStorage::GetFilePtr( BoyFileHandle hFile )
{
	FILE *pRet = NULL;

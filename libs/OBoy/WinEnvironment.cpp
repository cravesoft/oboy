              ...
              const std::string &gui)
{
	...
	mResourceSaver = new WinResourceSaver(langs[0], 
		langs.size()>1 ? langs[1] : "", 
		mPlatformInterface);
...
LineStrip *WinEnvironment::createLineStrip(int numVerts)
{
...
{
#if defined (_DEBUG) || defined (OBOY_PLATFORM_WIN32)
	// write to console:
